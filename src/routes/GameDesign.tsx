    ...
    return (
        <div className={"App"}>
            ...
            <div className={"page_content"}>
                ...
                " layout/color pallete you want to imitate, and start taking photos!"} link={""}></ImageLeft>
                ...
                "The game was designed with certain restrictions imposed: the game cannot have any color and it must " +
                           "be 16x16 \"beads\" in size."} link={"https://echoct21.github.io/GitHub/2900/A39/game.html"} linkText={"Game Link"}></ImageLeft>
                <ImageLeft imgSrc={Alien} alt={"Alien Adventure Logo"} title={"Alien Adventure"} text={"A 2D adventure" +
                    ...
                    "trying to eat you. Programming by me, ASCII art by Jay Weil."} link={"https://agaricspot.itch.io/alien-adventure"}
                linkText={"Game Link"}></ImageLeft>
            </div>
